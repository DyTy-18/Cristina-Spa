...
@endphp
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Nueva Entrada de Mercancía</h3>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form action="{{ route('admin.inventario.entradas.store') }}" method="POST">
                @csrf
                ...
                <div style="display:flex; gap:0.75rem; margin-top:1.5rem;">
                    ...
                    <a href="{{ route('admin.inventario.entradas') }}" class="btn btn-outline">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
